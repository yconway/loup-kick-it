namespace Loupedeck.LoupKickItPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LoupKickItPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LoupKickItPlugin.Resources.Resource.txt`.
